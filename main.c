...
int main(int argc, char* argv[]) {
    ...
    // Pièce 1
    pieces[0].name = "p1";
    pieces[0].image = load_image("p1.png");
    ...
    // Pièce 2
    pieces[1].name = "p2";
    pieces[1].image = load_image("p2.png");
    ...
    // Pièce 3
    pieces[2].name = "p3";
    pieces[2].image = load_image("p3.png");
    ...
    while (!quit) {
        ...
        if (all_correct && !victory && !game_over) {
            victory = 1;
            SDL_Surface *message = load_image("victory.png");
            if (message) {
        ...
        if (game_over && !victory) {
            SDL_Surface *fail_msg = load_image("echec.png"); 
            if (fail_msg) {

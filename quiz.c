...
int quiz() {
    ...
    if (Mix_OpenAudio(44100, MIX_DEFAULT_FORMAT, 2, 1024) < 0) {
        ...
        click= Mix_LoadWAV("son/son.wav");
        music = Mix_LoadMUS("son/music.wav");
        if (!click) {
            printf("Erreur de chargement de son.wav : %s\n", Mix_GetError());
        }
        if (!music) {
            printf("Erreur de chargement de music.mp3 : %s\n", Mix_GetError());
        }
    }
    ...
    // Charger les fonds
    SDL_Surface* bg1 = load_image("pic/bg1.png");
    SDL_Surface* bg2 = load_image("pic/bg2.png");
    if (!bg1 || !bg2) {
        SDL_Quit();
        return 1;
    }
    ...
    // Charger les boutons
    SDL_Surface* bq = load_image("pic/bq.png");
    SDL_Surface* bq_h = load_image("pic/bq_h.png");
    SDL_Surface* bp = load_image("pic/bp.png");
    SDL_Surface* bp_h = load_image("pic/bp_h.png");
    SDL_Surface* b1 = load_image("pic/b1.png");
    SDL_Surface* b1_h = load_image("pic/b1_h.png");
    SDL_Surface* b2 = load_image("pic/b2.png");
    SDL_Surface* b2_h = load_image("pic/b2_h.png");
    SDL_Surface* b3 = load_image("pic/b3.png");
    SDL_Surface* b3_h = load_image("pic/b3_h.png");
    ...
    TTF_Font* font = TTF_OpenFont("alagard.ttf", 24);
    if (!font) {
    ...
    // Charger les énigmes
    Enigme enigmes[10];
    int enigme_count = load_enigmes(enigmes, "questions.txt", font, text_color);
    if (enigme_count == 0) {
